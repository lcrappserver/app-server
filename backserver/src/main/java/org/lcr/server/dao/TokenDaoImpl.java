...
public class TokenDaoImpl implements TokenDao {
    ...
    public BackTokenEntity getToken(BackTokenEntity vo) {
        ...
        String sql = "select login_name, password, access_token, user_id " +
                "from tu_back_user_token " +
                "where login_name = ? and password = ?";
        List<BackTokenEntity> list = jdbcTemplate.query(sql,
                new Object[] {vo.getLoginName(), vo.getPassword()},
                new int[] {Types.VARCHAR, Types.VARCHAR},
                new RowMapper<BackTokenEntity>() {
    ...
    public BackUserInfoEntity getUserInfo(BackTokenEntity vo) {
        ...
        List<BackUserInfoEntity> list = jdbcTemplate.query(sql,
                new Object[] {vo.getLoginName(), vo.getPassword()},
                new int[] {Types.VARCHAR, Types.VARCHAR},
                new RowMapper<BackUserInfoEntity>() {
